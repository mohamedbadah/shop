                    ...
                    <form action="{{route('login')}}" class="card login-form" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="social-login">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12"><a class="btn google-btn"
                                            href="{{route('loginwithprovider','google')}}"><i class="lni lni-google"></i> Google login</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" name="{{config('fortify.username')}}" type="email" id="reg-email">
                            </div>
                            <div class="form-group input-group">
