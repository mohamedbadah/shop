                                ...
                                <li>
                                    {{-- <div class="select-position">
                                        ...
                                        <select name="currency" onchange="this.form.submit()">
                                            ...
                                            <option value="JOD" @selected('JOD'==session("currency_code"))>₹ INR</option>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="top-end">
                            ...
                            <ul class="user-login">
                                ...
                                <li>
                                    <a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('register').submit()">logout</a>
                                    <form action="{{route('logout')}}" method="POST" id="register" style="display:none">
                                     @csrf
                                     </form>
                                </li>
                            </ul>
